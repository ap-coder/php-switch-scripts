...
sudo  apt-get install -y --no-install-recommends libmagickwand-dev
sudo apt-get install -y php8.1-bz2 php8.1-curl php8.1-gd php8.1-mbstring php8.1-mysql php8.1-opcache  php8.1-redis php8.1-readline php8.1-soap php8.1-sqlite3 php8.1-tidy php8.1-xml php8.1-xsl php8.1-imagick php8.1-zip libapache2-mod-php8.1  > /dev/null
